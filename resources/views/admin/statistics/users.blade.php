...
<div>
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>@lang('blade_templates.admin.statistics.users') </h2>
                ...
                <div class="x_content">
                    <br />
                    <form id="statistics_form" method="post" action="{{ route('admin.statistics.users') }}" data-parsley-validate class="form-horizontal form-label-left">
                        {{ csrf_field() }}
                        ...
                        @include('blocks.search', ['field' => 'users*created_at'])
